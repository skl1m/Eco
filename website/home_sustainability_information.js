/**
This file will get called in html file to display the table value for sustainability at Home.
...
// sustainableHome: displays the sustainable tip for home.
function sustainableHome(){
	...
	result.data.Items.forEach(function(item){
		// if location value is equal to home than display sustainability tip. otherwise skip.
		if((item.place).localeCompare("home")==0){
