/**
This file will get called in html file to display the table value for sustainability at School.
...
// sustainableHome: displays the sustainable tip for school.
function sustainableSchool(){
...
result.data.Items.forEach(function(item){
	// if location value is equal to School than display sustainability tip. otherwise skip.
  if((item.place).localeCompare("school")==0){
...
document.getElementById("demo").innerHTML = sustainableSchool();